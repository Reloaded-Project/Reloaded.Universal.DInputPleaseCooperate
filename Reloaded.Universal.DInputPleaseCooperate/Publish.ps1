...
param (
    ...
    ## => User Config <= ## 
    $ProjectPath = "Reloaded.Universal.DInputPleaseCooperate.csproj",
    $PackageName = "Reloaded.Universal.DInputPleaseCooperate",
    ...
    $NuGetPackageId = "Reloaded.Universal.DInputPleaseCooperate",
